...
public class BeanbagControls : ObjectControls
{
    ...
    {
        return new Vector3(-powerPercent * Mathf.Sin(_angle) * forceMultiplyer / 6.85f, powerPercent * heightMultipliter / 6.85f, -powerPercent * Mathf.Cos(_angle) * forceMultiplyer / 6.85f);
    }
