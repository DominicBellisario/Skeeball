...
public abstract class ManagerBase : MonoBehaviour
{
    ...
    [SerializeField] protected GameObject beanbagPrefab;
    [SerializeField] protected Vector3 objectCameraOffset;
    [SerializeField] protected bool switchCameraOnLaunch;
    //the time between the last active objects and a new spawn
    [SerializeField] protected float timeBetweenObjects;

    //the place in the level the objects spawn in
    protected GameObject objectSpawnPos;
    ...
    protected int goldBallPow;
    protected int markedBallPow;
    protected int triBallPow;
    protected int lobBallPow;
    protected bool lobBallEnabled;
